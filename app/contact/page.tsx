  ...
  return (
    <div className="relative w-full overflow-x-hidden">
      <main className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen transition-colors duration-300 relative w-full">
        ...
        {/* Hero Section */}
        <section className="relative min-h-[60vh] md:min-h-[50vh] flex items-center justify-center">
          {/* Background Elements */}
          <div className="absolute inset-0 z-0 pointer-events-none">
            {/* Background gradient and pattern */}
            <div className="absolute inset-0 bg-gradient-to-b from-gray-50/80 via-gray-50/95 to-white dark:from-gray-900/80 dark:via-gray-900/95 dark:to-gray-900 backdrop-blur-sm" />
            <div className="absolute inset-0 bg-grid-pattern opacity-[0.05]" />
            
            {/* Decorative shapes - Using transform instead of positioning for better performance */}
            <div className="absolute inset-0">
              <div className="absolute top-1/4 left-0 w-64 h-64 bg-[#E31E24]/5 rounded-full blur-3xl transform-gpu translate-x-[-50%]" />
              <div className="absolute bottom-1/4 right-0 w-64 h-64 bg-[#0A1E3C]/5 rounded-full blur-3xl transform-gpu translate-x-[50%]" />
            </div>

            {/* Left side pest icons - Using transform for positioning */}
            <div className="absolute inset-0">
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                className="absolute left-[5%] sm:left-[10%] top-[45%] transform-gpu"
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="w-12 h-12 md:w-20 md:h-20 opacity-40 dark:opacity-20 transform -rotate-12 select-none"
                />
              </motion.div>
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                ...
                className="absolute left-[15%] sm:left-[25%] bottom-[20%] transform-gpu"
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  className="w-10 h-10 md:w-16 md:h-16 opacity-40 dark:opacity-20 transform rotate-12 select-none"
                />
              </motion.div>
            </div>

            {/* Right side pest icons - Using transform for positioning */}
            <div className="absolute inset-0">
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.8, delay: 0.4 }}
                className="absolute right-[5%] sm:right-[15%] top-[50%] transform-gpu"
              >
                <Image
              ...
              <motion.div
                ...
                className="absolute right-[15%] sm:right-[25%] bottom-[15%] transform-gpu"
              >
                <Image
          ...
          {/* Content */}
          <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20 pb-12">
            <motion.div
            ...
            >
              <motion.span
                ...
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5 }}
                className="inline-block px-4 py-1.5 bg-red-50 dark:bg-red-900/20 text-red-600 rounded-full text-sm font-medium mb-4 shadow-sm"
              >
              ...
              <motion.h1
                ...
                className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[#0A1E3C] to-[#E31E24] dark:from-white dark:to-[#E31E24]"
              >
